...
export class StudentLocationSelection extends Component {
    constructor(props) {
        super(props)
    ...
    districtSelected(id, index){
        let paths = document.getElementsByTagName("path");
        var i;
        for(i = 0; i<paths.length; i++){
            paths[i].style.fill = "#151965"
            paths[i].style.hover = "#C060A1"
        }
...
export default StudentLocationSelection
